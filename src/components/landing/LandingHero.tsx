      ...
      <div className="container py-12 md:py-16 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <section className="order-1 lg:order-2">
            <div 
              className="relative bg-background rounded-3xl p-8 md:p-10 shadow-xl border-2 border-primary/20 overflow-hidden"
            >
              {/* Decorative gradient */}
              ...
              <div className="relative z-10 space-y-6">
                ...
                <div className="space-y-3 py-4 border-y border-border/50">
                  {[
                    "Free QR code for your vehicle",
                    "Instant alert notifications",
                    "Anonymous chat with scanners",
                  ].map((item, index) => (

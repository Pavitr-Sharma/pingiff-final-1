          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    To create a world where vehicle owners can be contacted safely 
                    and privately, without the fear of spam or harassment.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Your phone number is never shared. All calls are masked and 
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Built with feedback from thousands of vehicle owners across 
                    100+ cities in India.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Proudly designed and manufactured in India, for Indian vehicle 
                    owners.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-primary rounded-2xl p-8">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                ...
                <div>
                  <div className="text-3xl font-bold text-foreground">1L+</div>
